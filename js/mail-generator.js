(function(){
  ...
  window.geemails = ["date","subject","sender","body"];
...
// h3ele.id = "inbox counter";
// h3ele.innerHTML = window.geemails.length;

// function click(){
//   var clicked =document.getElementByClassName(subjbox);

//    clicked.addEventListener('onclick',clicked);
// }



// function setInterval(getNewMessage){

// return 



// var inbox = document.createElement("h3");
// inbox.className = "inbox";
// inbox.innerHTML = window.geemails.length;
// inbox = window.geemails.length;
...
//   var subjectBox = document.createElement('div');
//   subjectBox.className = "container";
//   document.body.appendChild(subjectBox);

// //   var productBox = document.createElement('div');
// //   productBox.className = "stuff";
// //   productBox.innerHTML = subject.
